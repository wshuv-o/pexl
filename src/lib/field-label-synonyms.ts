...
export const FIELD_LABEL_SYNONYMS: Record<string, string[]> = {
  ...
  billing_date:          ['billing date', 'bill date', 'statement date', 'invoice date', 'date of bill'],
  total_gas_bill:        ['total gas', 'gas charges', 'total amount due', 'amount due'],
  total_electricity_bill:['total electricity', 'electric charges', 'electricity charges', 'total amount due'],
  total_water_bill:      ['total water', 'water charges', 'amount due'],
  total_sewer_bill:      ['total sewer', 'sewer charges'],
  total_water_sewer_bill:['total water & sewer', 'water and sewer'],
  total_internet_bill:   ['total internet', 'internet charges'],
  total_phone_bill:      ['total phone', 'phone charges'],
  total_trash_bill:      ['total trash', 'trash charges', 'refuse'],
  ...
  total_credits:         ['total credits', 'total deposits', 'credits'],
  total_debits:          ['total debits', 'total withdrawals', 'debits'],

  // ── Appraisal ─────────────────────────────────────────────────────
  appraised_date:        ['appraised date', 'appraisal date', 'valuation date', 'effective date'],
  appraised_as_is_value: ['as-is value', 'appraised value', 'market value', 'as is value'],
  ...
  lease_end_date:             ['lease end', 'lease expiration', 'end date', 'termination date'],
  security_deposit:           ['security deposit', 'deposit'],
  monthly_rent:               ['monthly rent', 'rent', 'base rent'],
  ...
  total_tax_due:              ['total tax due', 'total due', 'amount due'],
  parcel_id:                  ['parcel id', 'parcel number', 'apn', 'property id'],
};
